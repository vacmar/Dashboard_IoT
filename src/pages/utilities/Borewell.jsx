...
const borewellData = [
  { label: 'Borewell 1', time: '0:1:0', cycles: 0, highlight: true },
  { label: 'Borewell 2', time: '0:0:0', cycles: 0, highlight: false },
  { label: 'Borewell 3', time: '0:0:0', cycles: 0, highlight: false },
  { label: 'Borewell 4', time: '0:0:0', cycles: 0, highlight: true },
  { label: 'Borewell 5', time: '0:0:0', cycles: 0, highlight: false },
  { label: 'Borewell 6', time: '0:0:0', cycles: 0, highlight: false },
  { label: 'Borewell 7', time: '0:0:0', cycles: 0, highlight: false },
  { label: 'Borewell 8', time: '0:0:0', cycles: 0, highlight: false }
]
